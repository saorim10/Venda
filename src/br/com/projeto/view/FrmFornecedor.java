...
public class FrmFornecedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        paneClientes.addTab("Dados Comerciais", paneDados);
        ...
        paneClientes.addTab("Consulta de Fornecedores", paneConsulta);
    ...
    private void TabelaFornecedoresMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaFornecedoresMouseClicked
        ...
        cBoxUf.setSelectedItem(TabelaFornecedores.getValueAt(TabelaFornecedores.getSelectedRow(), 12).toString());
    ...
    private void btnConsultaNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultaNomeActionPerformed
        ...
        obj = dao.consultaPorNomeFornecedor(nome);
